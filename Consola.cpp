...
// Usa fun��es n�po documentadas da Microsoft (s�o secretas :) )
...
void Consola::setTextSizeXP(int x, int y){
	...
	for (size_t i = 0; i < NumFonts; ++i) {
		...
		// isto � mesmo for�a bruta, mas no XP, � o que h�
		//  - usar s� se se estiver mesmo no XP
		//  - reclama��es:  weCareAboutYou@microsft.com
	}
...
// os alunos que gostarem de iform�tica podem pegar nisto
